...
public:
  ...
  uint32_t minedMoneyUnlockWindow_v1() const { return m_minedMoneyUnlockWindow_v1; }
...
private:
  ...
  uint32_t m_minedMoneyUnlockWindow_v1;
...
public:
  ...
  CurrencyBuilder& minedMoneyUnlockWindow_v1(uint32_t val) { m_currency.m_minedMoneyUnlockWindow_v1 = val; return *this; }
